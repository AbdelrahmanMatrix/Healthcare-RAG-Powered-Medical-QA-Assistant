> **[HISTORICAL — PRE-REPAIR]** Written May 2026 (auto-generated by NB09). Describes the pre-repair pipeline and the deprecated meta-llama/llama-4-scout-17b-16e-instruct generator; several details (top-5 retrieval, max tokens, category routing internals) differ from the current implementation. See README.md for current configuration.
