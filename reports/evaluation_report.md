> **[HISTORICAL — PRE-REPAIR]** Metrics from the May 2026 run (pre-P0 repairs). This run predates: the grounding repair (P0.3), the leakage-free classifier split (P0.4), matched baseline decoding and injected-evidence faithfulness (P0.5). It also contains a corrupted table line. Superseded by the canonical report regenerated by `notebooks/08_evaluation.ipynb`; archived copy: `reports/evaluation_report_historical.md`.
